...
const GUESSER_TARGET_NUMBER = 120; // The number that the Guesser is trying to get to.

if (GUESSER_TARGET_NUMBER > GUESSER_GENE_MAX * 2) {
    throw "Guesser cannot ever guess the target, even with maxed out genes";
}

const MAX_MUTATION_PERCENTAGE = 10;
const STARTING_PARENTS = 10;
const PARENT_PICK_PERCENTAGE = 50;
